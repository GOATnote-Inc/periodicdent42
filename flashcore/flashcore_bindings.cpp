...
torch::Tensor launch_v8_dynamic(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    double scale) {
...
torch::Tensor launch_v9_warp_spec(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    double scale) {
...
torch::Tensor launch_v10_3stage(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    double scale) {
...
torch::Tensor launch_v9_1_verified(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    double scale) {
    ...
    flashcore_v9_1_verified_launch(
        reinterpret_cast<const half*>(q.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(k.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(v.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
torch::Tensor launch_v9_3_excellence(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    double scale) {
    ...
    flashcore_v9_3_excellence_launch(
        reinterpret_cast<const half*>(q.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(k.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(v.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
torch::Tensor launch_v11_persistent(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    double scale) {
    ...
    flashcore_v11_persistent_launch(
        reinterpret_cast<const half*>(q.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(k.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(v.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
torch::Tensor launch_v12_expert(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    double scale) {
...
torch::Tensor launch_v13_excellence(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    double scale) {
    ...
    flashcore_v13_excellence_launch(
        reinterpret_cast<const half*>(q.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(k.data_ptr<at::Half>()),
        reinterpret_cast<const half*>(v.data_ptr<at::Half>()),
        reinterpret_cast<half*>(output.data_ptr<at::Half>()),
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("v8_dynamic", &launch_v8_dynamic, "FlashCore v8 - Proper dynamic SMEM (48×32 asymmetric)",
          py::arg("q"), py::arg("k"), py::arg("v"), py::arg("scale"));
    m.def("v9_warp_spec", &launch_v9_warp_spec, "FlashCore v9 - Warp Specialization (12 compute + 4 producer)",
          py::arg("q"), py::arg("k"), py::arg("v"), py::arg("scale"));
    m.def("v10_3stage", &launch_v10_3stage, "FlashCore v10 - 3-Stage Pipeline (better latency hiding)",
          py::arg("q"), py::arg("k"), py::arg("v"), py::arg("scale"));
    m.def("v9_1_verified", &launch_v9_1_verified, "FlashCore v9.1 - Verified Warp Specialization (deadlock-free)",
          py::arg("q"), py::arg("k"), py::arg("v"), py::arg("scale"));
    m.def("v9_3_excellence", &launch_v9_3_excellence, "FlashCore v9.3 - Final Excellence (32×32, 4 CTAs/SM, ≤28µs target)",
          py::arg("q"), py::arg("k"), py::arg("v"), py::arg("scale"));
    m.def("v11_persistent", &launch_v11_persistent, "FlashCore v11 - Persistent CTA + cuda::pipeline (32×48, ≤28µs)",
          py::arg("q"), py::arg("k"), py::arg("v"), py::arg("scale"));
    m.def("v12_expert", &launch_v12_expert, "FlashCore v12 - Expert Deadlock-Free (32×48, ≤28µs)",
          py::arg("q"), py::arg("k"), py::arg("v"), py::arg("scale"));
    m.def("v13_excellence", &launch_v13_excellence, "FlashCore v13 - Excellence WMMA (32×48, ≤28µs, 4 CTAs/SM)",
          py::arg("q"), py::arg("k"), py::arg("v"), py::arg("scale"));
}
