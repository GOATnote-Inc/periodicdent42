...
USE_FUSED_SOFTMAX = int(os.environ.get("USE_FUSED_SOFTMAX", "1"))  # Stage-3: fused softmax in registers
USE_SMEM_SWIZZLE_XOR = int(os.environ.get("USE_SMEM_SWIZZLE_XOR", "1"))  # Stage-3: XOR swizzle for bank conflicts
