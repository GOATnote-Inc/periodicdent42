...
def build_v3_release(debug: bool = False):
    ...
    # WMMA defines disabled for V3 (causes preprocessor conflicts with Traits::STAGES)
    # V3 uses template parameters, not compile-time defines
    # if os.environ.get("USE_WMMA", "0") == "1":
