// ============================================================================
// PYBIND11 BINDINGS FOR MINIMAL FLASHATTENTION KERNEL
// ============================================================================
...
torch::Tensor flash_attention_minimal_forward(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    float softmax_scale
    ...
    TORCH_CHECK(head_dim == 64, 
                "Only HEAD_DIM=64 supported in minimal version");
    ...
    // Launch kernel
    launch_flash_attention_minimal(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward", &flash_attention_minimal_forward, 
          "Minimal FlashAttention Forward (Correctness-First)",
          py::arg("q"),
          py::arg("k"),
          py::arg("v"),
