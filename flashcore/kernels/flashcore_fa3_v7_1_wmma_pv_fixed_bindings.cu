// flashcore_fa3_v7_1_wmma_pv_fixed_bindings.cu
    ...
    bool is_causal=false)
{
  ...
  launch_flash3_v7_1_wmma_pv_fixed(Qp, Kp, Vp, Op, (int)B, (int)H, (int)S, (int)D, is_causal, stream);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &flash3_forward, "FA-3 v7.1 (WMMA QK^T + PV FIXED - Fragment staging!)",
