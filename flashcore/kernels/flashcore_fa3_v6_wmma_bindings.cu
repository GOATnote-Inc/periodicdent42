// flashcore_fa3_v6_wmma_bindings.cu
    ...
    bool is_causal=false)
{
  ...
  launch_flash3_v6_wmma(Qp, Kp, Vp, Op, (int)B, (int)H, (int)S, (int)D, is_causal, stream);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &flash3_forward, "FA-3 v6 (WMMA QK^T - Phase 1)",
