...
print("=" * 70)
print("Building FA-3 v7_wmma_pv Kernel (Phase 2: WMMA QK^T + PV (FULL Tensor Cores!)!)")
print("=" * 70)

src_dir = Path(__file__).parent / "kernels"

sources = [
    str(src_dir / "flashcore_fa3_v7_wmma_pv.cu"),
    str(src_dir / "flashcore_fa3_v7_wmma_pv_bindings.cu"),
]
...
try:
    ...
    print("=" * 70)
    print("Module: flashcore_fa3_v7_wmma_pv.forward(Q, K, V, is_causal=False)")
    print()
