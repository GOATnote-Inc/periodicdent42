...
print("=" * 70)
print("Building FA-3 v4 Kernel (CORRECT Loop Order!)")
print("=" * 70)

src_dir = Path(__file__).parent / "kernels"

sources = [
    str(src_dir / "flashcore_fa3_v4.cu"),
    str(src_dir / "flashcore_fa3_v4_bindings.cu"),
]
...
try:
    ...
    print("=" * 70)
    print("Module: flashcore_fa3_v4.forward(Q, K, V, is_causal=False)")
    print()
