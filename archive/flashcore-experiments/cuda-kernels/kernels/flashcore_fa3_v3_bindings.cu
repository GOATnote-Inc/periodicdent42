    ...
    bool is_causal=false)
{
  ...
  launch_flash3_v3(Qp, Kp, Vp, Op, (int)B, (int)H, (int)S, (int)D, is_causal, stream);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &flash3_forward, "FA-3 v3 (inverted loops + optimized)",
