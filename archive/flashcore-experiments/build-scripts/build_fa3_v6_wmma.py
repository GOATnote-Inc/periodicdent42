...
print("=" * 70)
print("Building FA-3 v6_wmma Kernel (Phase 1: WMMA QK^T (Tensor Cores!)!)")
print("=" * 70)

src_dir = Path(__file__).parent / "kernels"

sources = [
    str(src_dir / "flashcore_fa3_v6_wmma.cu"),
    str(src_dir / "flashcore_fa3_v6_wmma_bindings.cu"),
]
...
try:
    ...
    print("=" * 70)
    print("Module: flashcore_fa3_v6_wmma.forward(Q, K, V, is_causal=False)")
    print()
