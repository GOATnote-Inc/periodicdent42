...
---
Generated by Periodic Labs BETE-NET Integration v{prediction.model_version}
https://github.com/periodiclabs/ard-intelligence
""".strip()
...
- **Periodic Labs**: b@thegoatnote.com
