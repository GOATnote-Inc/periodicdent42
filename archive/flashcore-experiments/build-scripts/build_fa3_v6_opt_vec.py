...
print("=" * 70)
print("Building FA-3 v6_opt_vec Kernel (v6 Optimized: WMMA QK^T + Vectorized Loads!!)")
print("=" * 70)

src_dir = Path(__file__).parent / "kernels"

sources = [
    str(src_dir / "flashcore_fa3_v6_opt_vec.cu"),
    str(src_dir / "flashcore_fa3_v6_opt_vec_bindings.cu"),
]
...
try:
    ...
    print("=" * 70)
    print("Module: flashcore_fa3_v6_opt_vec.forward(Q, K, V, is_causal=False)")
    print()
