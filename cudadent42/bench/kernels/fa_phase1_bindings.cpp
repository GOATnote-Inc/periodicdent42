// ============================================================================
// PYBIND11 BINDINGS FOR PHASE 1 KERNEL
// ============================================================================
...
torch::Tensor flash_attention_phase1_forward(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v,
    float softmax_scale
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward", &flash_attention_phase1_forward, 
          "FlashAttention Phase 1 (Block Tiling)",
          py::arg("q"),
          py::arg("k"),
          py::arg("v"),
