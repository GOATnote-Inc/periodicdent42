// flashcore_fa3_v7_wmma_pv_bindings.cu
    ...
    bool is_causal=false)
{
  ...
  launch_flash3_v7_wmma_pv(Qp, Kp, Vp, Op, (int)B, (int)H, (int)S, (int)D, is_causal, stream);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &flash3_forward, "FA-3 v7 (WMMA QK^T + PV - Phase 2 FULL TENSOR CORES!)",
